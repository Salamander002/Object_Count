...
PUSH	macro
        movwf		ContextW		;ContextW must be reserved in all banks
	    swapf		STATUS, W	    ;store in W without affecting status bits
	    movwf		ContextS	    ;save STATUS
	    endm

;Used to load WReg and STATUS Register into other temporary registers;
POP	    macro
	    swapf		ContextS, W     ;unswap STATUS nibbles into W
	    movwf		STATUS		    ;restore STATUS (which points to where W was stored)
	    swapf		ContextW, F		;unswap W nibbles
	    swapf		ContextW, W		;restore W without affecting STATUS
	    endm
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;                         Start of Program                           ;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;Prepare timer0 to interrupt after  1.024 Micro Seconds              ;
...
Right
	    MOVLW       	b'00001000'		    ;no need to check SenseRight
	    XORWF           State, F
...
Left
	    MOVLW          	b'00000100'		    ;Complement VarL
	    XORWF          	State, F
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;Display;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;this subroutine gets executed every 1.024 mS
